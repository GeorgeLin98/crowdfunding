...
CREATE TABLE `t_address`  (
  ...
  `member_id` int(0) NULL DEFAULT NULL COMMENT '用户 id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_member`  (
  ...
  `authstatus` int(0) NULL DEFAULT NULL COMMENT '实名认证状态0 - 未实名认证， 1 - 实名认证申\r\n请中， 2 - 已实名认证',
...
CREATE TABLE `t_member_confirm_info`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `memberid` int(0) NULL DEFAULT NULL COMMENT '会员id',
...
CREATE TABLE `t_order`  (
  ...
  `invoice` int(0) NULL DEFAULT NULL COMMENT '是否开发票（0 不开，1 开）',
...
CREATE TABLE `t_order_project`  (
  ...
  `support_price` int(0) NULL DEFAULT NULL COMMENT '支持单价',
...
CREATE TABLE `t_project`  (
  ...
  `memberid` int(0) NULL DEFAULT NULL COMMENT '发起人的会员id',
